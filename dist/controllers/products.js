...
const products_types_1 = require("../types/products.types");
...
const productsController = {
    getProducts: (req, res, next) => {
        ...
        if (!Object.keys(req.query).length) {
            ...
            const searchParamsKeys = Object.keys(req.query).map((key) => `city.${products_types_1.ResponseToDBParamsMap[key]} = ?`).join(' AND ');
